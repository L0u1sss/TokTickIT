...
try{
  ...
  await run(path.join(client,"node_modules/@playwright/test/cli.js"),["test",communications ? "e2e/lab-03/comments-notes.spec.ts" : staffQueue ? "e2e/lab-03/staff-queue.spec.ts" : "e2e/lab-03/authentication.spec.ts","--config","playwright.live.config.ts"],client,
